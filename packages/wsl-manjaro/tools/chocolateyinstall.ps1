...
$packageArgs = @{
  ...
  url           = 'https://github.com/sileshn/ManjaroWSL2/releases/download/20240606/ManjaroWSL2.zip'
  checksum      = 'ab8a393ded02417e54881bcaaf736da1ea9134aeaf64b91044c13267bbc5769a'
  checksumType  = 'sha256'
