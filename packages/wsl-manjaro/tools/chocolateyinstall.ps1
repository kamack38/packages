...
$packageArgs = @{
  ...
  url           = 'https://github.com/sileshn/ManjaroWSL2/releases/download/20250801/ManjaroWSL2.zip'
  checksum      = '6b58d611fbc625131fed251ad8344bb4896986df733729d97b5745e7843e97c6'
  checksumType  = 'sha256'
