...
$packageArgs = @{
  ...
  url           = 'https://github.com/sileshn/ManjaroWSL2/releases/download/20230201/ManjaroWSL2.zip'
  checksum      = '3b733033b8ab4df1bd0faa52b397f3883f8b84beff59e7845b63df05844d9191'
  checksumType  = 'sha256'
