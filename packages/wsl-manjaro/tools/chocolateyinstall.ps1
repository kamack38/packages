...
$packageArgs = @{
  ...
  url           = 'https://github.com/sileshn/ManjaroWSL2/releases/download/20250501/ManjaroWSL2.zip'
  checksum      = '47e5112b831d0393c7b54884006a331162f91f402dacd7a7fceba26203268928'
  checksumType  = 'sha256'
