...
$packageArgs = @{
  ...
  url           = 'https://github.com/sileshn/ManjaroWSL2/releases/download/20240102/ManjaroWSL2.zip'
  checksum      = '32678ddb7ab1f8bf49b57b907d3ab5dd5477bb522c7730ac9ced4ec93c6d2618'
  checksumType  = 'sha256'
