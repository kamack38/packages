...
$packageArgs = @{
  ...
  url           = 'https://github.com/sileshn/ManjaroWSL2/releases/download/20260101/ManjaroWSL2.zip'
  checksum      = '9fe2cf8f09829ca5abe8fd4cec01fdba873f6587954f540b0e7166b3a7bfec93'
  checksumType  = 'sha256'
