...
$packageArgs = @{
  ...
  url           = 'https://github.com/sileshn/ManjaroWSL2/releases/download/20250403/ManjaroWSL2.zip'
  checksum      = '3bfceed30877d6c78390cb9a0846b089a83325d19cb877e5c479a693db2f334b'
  checksumType  = 'sha256'
