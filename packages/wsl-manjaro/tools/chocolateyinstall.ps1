...
$packageArgs = @{
  ...
  url           = 'https://github.com/sileshn/ManjaroWSL2/releases/download/20250701/ManjaroWSL2.zip'
  checksum      = 'd6522154541a3ebe454cfc71f6bd9ab1600c76aa76e7ddc3a1590b2b476283fd'
  checksumType  = 'sha256'
