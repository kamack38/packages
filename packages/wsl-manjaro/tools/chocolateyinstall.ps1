...
$packageArgs = @{
  ...
  url           = 'https://github.com/sileshn/ManjaroWSL2/releases/download/20240301/ManjaroWSL2.zip'
  checksum      = 'e81bbcc14c255a2e2d2c80185c6bf15be675a9381b4fa222c6907dc2fc37b25c'
  checksumType  = 'sha256'
