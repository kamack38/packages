...
$packageArgs = @{
  ...
  url           = 'https://github.com/sileshn/ManjaroWSL2/releases/download/20260430/ManjaroWSL2.zip'
  checksum      = '593f0d42a61e82b7aa2b15bb28e81cf2cba800158d80e214a6fad116efdd2166'
  checksumType  = 'sha256'
