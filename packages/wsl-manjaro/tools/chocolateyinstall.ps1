...
$packageArgs = @{
  ...
  url           = 'https://github.com/sileshn/ManjaroWSL2/releases/download/20260601/ManjaroWSL2.zip'
  checksum      = '20281ba85bedbd20242e1c0d04801eefd6a147ad07745b6cdbe3fd090c2fa7f0'
  checksumType  = 'sha256'
