...
$packageArgs = @{
  ...
  url           = 'https://github.com/sileshn/ManjaroWSL2/releases/download/20230905/ManjaroWSL2.zip'
  checksum      = '938833b744d945e8e1d79ddee2f508f31a7661d341498e6fe324c35d55b8eebc'
  checksumType  = 'sha256'
